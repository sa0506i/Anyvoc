/**
 * chunkText — split long texts at sentence boundaries so the LLM call
 * stays under Mistral's context window for practical prompt+response
 * budgets. Phase 2 Slice 1 extracted from lib/claude.ts; semantics
 * unchanged.
 */
